module.exports = [
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/binary_impl.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createSimpleBinaryKernelImpl(op) {
    return (aShape, bShape, aVals, bVals, dtype)=>{
        const newShape = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].assertAndGetBroadcastShape(aShape, bShape);
        const resultRank = newShape.length;
        const resultStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(newShape);
        const resultSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(newShape);
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType(dtype, resultSize);
        const aRank = aShape.length;
        const bRank = bShape.length;
        const aStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(aShape);
        const bStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(bShape);
        const aBroadcastDims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getBroadcastDims(aShape, newShape);
        const bBroadcastDims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getBroadcastDims(bShape, newShape);
        if (aBroadcastDims.length + bBroadcastDims.length === 0) {
            ...
            for(let i = 0; i < result.length; ++i){
                const loc = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].indexToLoc(i, resultRank, resultStrides);
                const aLoc = loc.slice(-aRank);
                aBroadcastDims.forEach((d)=>aLoc[d] = 0);
                const aIndex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].locToIndex(aLoc, aRank, aStrides);
                const bLoc = loc.slice(-bRank);
                bBroadcastDims.forEach((d)=>bLoc[d] = 0);
                const bIndex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].locToIndex(bLoc, bRank, bStrides);
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/zeros_impl.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function zeros(backend, shape, dtype = 'float32') {
    if (dtype === 'complex64') {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
            inputs: {
                real,
                imag
            },
    ...
    const values = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].makeZerosTypedArray(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(shape), dtype);
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/binary_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function binaryKernelFunc(name, simpleImpl, complexImpl, dtype) {
    if (complexImpl == null) {
        return ({ inputs, backend })=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].fromUint8ToStringArray(aVals) : aVals;
            const decodedBVals = a.dtype === 'string' ? // tslint:disable-next-line: no-any
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].fromUint8ToStringArray(bVals) : bVals;
    ...
    return ({ inputs, backend })=>{
        ...
        if (a.dtype === 'complex64' || b.dtype === 'complex64') {
            const $aComplex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Cast$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cast"])({
                inputs: {
                    x: a
                },
                backend: cpuBackend,
            ...
            const $bComplex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Cast$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["cast"])({
                inputs: {
                    x: b
                },
                backend: cpuBackend,
            ...
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
                inputs: {
                    real: resultReal,
                    imag: resultImag
                },
...
function createComplexBinaryKernelImpl(op) {
    return (aShape, bShape, aRealVals, aImagVals, bRealVals, bImagVals)=>{
        const resultShape = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].assertAndGetBroadcastShape(aShape, bShape);
        const resultSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(resultShape);
        const resultRank = resultShape.length;
        const resultStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(resultShape);
        const resultRealVals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType('float32', resultSize);
        const resultImagVals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType('float32', resultSize);
        const aBroadcastDims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getBroadcastDims(aShape, resultShape);
        const bBroadcastDims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getBroadcastDims(bShape, resultShape);
        const aVals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(aRealVals, aImagVals);
        const bVals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(bRealVals, bImagVals);
        const aRank = aShape.length;
        const aStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(aShape);
        const bRank = bShape.length;
        const bStrides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(bShape);
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/unary_impl.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createSimpleUnaryImpl(op) {
    return (values, dtype, attrs)=>{
        const newValues = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getArrayFromDType(dtype, values.length);
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/unary_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/backends/backend_util.js [app-route] (ecmascript) <export * as backend_util>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$cpu_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/cpu_util.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$utils$2f$unary_impl$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/unary_impl.js [app-route] (ecmascript)");
;
;
;
function unaryKernelFunc(name, op, dtype) {
    const impl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$utils$2f$unary_impl$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSimpleUnaryImpl"])(op);
    return unaryKernelFuncFromImpl(name, impl, dtype);
}
function unaryKernelFuncFromImpl(name, unaryImpl, dtype) {
    return ({ inputs, attrs, backend })=>{
        const { x } = inputs;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$cpu_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertNotComplex"])(x, name);
        const cpuBackend = backend;
        ...
        if (x.dtype === 'string') {
            ...
            decoded = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].fromUint8ToStringArray(values);
        } else {
            decoded = values;
        }
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/fused_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function applyActivation(backend, x, activation, preluActivationWeights, leakyreluAlpha) {
    if (activation === 'linear') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Identity$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["identity"])({
            inputs: {
                x
            },
            backend
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Relu$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["relu"])({
            inputs: {
                x
            },
            backend
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Elu$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["elu"])({
            inputs: {
                x
            },
            backend
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Relu6$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["relu6"])({
            inputs: {
                x
            },
            backend
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Prelu$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prelu"])({
            inputs: {
                x,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$LeakyRelu$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["leakyRelu"])({
            inputs: {
                x
            },
            backend,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Sigmoid$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sigmoid"])({
            inputs: {
                x
            },
            backend
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/pool_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function pool(xValues, xShape, dtype, strides, convInfo, poolType) {
    ...
    const output = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$buffer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buffer"])(convInfo.outShape, dtype);
...
function maxPoolPositions(xValues, xShape, dtype, convInfo, flattenPositions = false, includeBatchInIndex = false) {
    const maxPositions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$buffer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buffer"])(convInfo.outShape, 'int32');
    const strideHeight = convInfo.strideHeight;
    const strideWidth = convInfo.strideWidth;
    const dilationHeight = convInfo.dilationHeight;
    const dilationWidth = convInfo.dilationWidth;
    ...
    const padTop = convInfo.padInfo.top;
    const padLeft = convInfo.padInfo.left;
    const xBuf = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$buffer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buffer"])(xShape, dtype, xValues);
    for(let b = 0; b < convInfo.batchSize; ++b){
        for(let d = 0; d < convInfo.inChannels; ++d){
            for(let yR = 0; yR < convInfo.outHeight; ++yR){
                const xRCorner = yR * strideHeight - padTop;
...
"[project]/node_modules/@tensorflow/tfjs-backend-cpu/dist/utils/fft_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function fftBatch(input, inverse, cpuBackend) {
    ...
    const resultSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(resultShape);
    const resultReal = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType('float32', resultSize);
    const resultImag = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType('float32', resultSize);
    for(let b = 0; b < batch; b++){
        // TODO: Support slice ops for complex type.
        const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Slice$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slice"])({
            inputs: {
                x: real2D
            },
            backend: cpuBackend,
        ...
        const i = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Slice$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slice"])({
            inputs: {
                x: imag2D
            },
            backend: cpuBackend,
        ...
        const input = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
            inputs: {
                real: r,
                imag: i
            },
        ...
        const res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(real, imag);
        for(let d = 0; d < innerDim; d++){
            const c = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getComplexWithIndex(res, d);
...
function fftImpl(input, inverse, cpuBackend) {
    const inputSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(input.shape);
    const inputVals = cpuBackend.data.get(input.dataId);
    ...
    if (isExponentOf2(inputSize)) {
        ...
        if (inverse) {
            ...
            const sizeInfo = cpuBackend.makeTensorInfo([], 'float32', __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].createScalarValue(inputSize, 'float32'));
            const sizeInfoCopy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Identity$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["identity"])({
                inputs: {
                    x: sizeInfo
                },
                backend: cpuBackend
            });
            const divRealInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$RealDiv$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["realDivConfig"].kernelFunc({
                inputs: {
                    a: realInfo,
                    b: sizeInfo
                },
            ...
            const divImagInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$RealDiv$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["realDivConfig"].kernelFunc({
                inputs: {
                    a: imagInfo,
                    b: sizeInfoCopy
                },
        ...
        const data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(realVals, imagVals);
        const rawOutput = fourierTransformByMatmul(data, inputSize, inverse);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].splitRealAndImagArrays(rawOutput);
    }
}
...
function fftRadix2(realVals, imagVals, size, inverse, cpuBackend) {
    ...
    const data = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(realVals, imagVals);
    const half = size / 2;
    const evenComplex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].complexWithEvenIndex(data);
    ...
    const evenTensorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
        inputs: {
            real: evenRealInfo,
            imag: evenImagInfo
        },
    ...
    const oddComplex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].complexWithOddIndex(data);
    ...
    const oddTensorInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
        inputs: {
            real: oddRealInfo,
            imag: oddImagInfo
        },
    ...
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].exponents(size, inverse);
    const eShape = [
        e.real.length
    ];
    const eRealInfo = cpuBackend.makeTensorInfo(eShape, 'float32', e.real);
    const eImagInfo = cpuBackend.makeTensorInfo(eShape, 'float32', e.imag);
    const complexInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Complex$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["complex"])({
        inputs: {
            real: eRealInfo,
            imag: eImagInfo
        },
    ...
    const exponentInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Multiply$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["multiply"])({
        inputs: {
            a: complexInfo,
            b: $oddTensorInfo
        },
    ...
    const addPart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Add$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add"])({
        inputs: {
            a: $evenTensorInfo,
            b: exponentInfo
        },
    ...
    const subPart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Sub$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sub"])({
        inputs: {
            a: $evenTensorInfo,
            b: exponentInfo
        },
    ...
    const addPartReal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Real$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["real"])({
        inputs: {
            input: addPart
        },
        backend: cpuBackend
    });
    const subPartReal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Real$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["real"])({
        inputs: {
            input: subPart
        },
        backend: cpuBackend
    });
    const addPartImag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Imag$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["imag"])({
        inputs: {
            input: addPart
        },
        backend: cpuBackend
    });
    const subPartImag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Imag$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["imag"])({
        inputs: {
            input: subPart
        },
        backend: cpuBackend
    });
    const $real = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Concat$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["concat"])({
        inputs: [
            addPartReal,
            subPartReal
        ],
    ...
    const $imag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$cpu$2f$dist$2f$kernels$2f$Concat$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["concat"])({
        inputs: [
            addPartImag,
            subPartImag
        ],
...
function fourierTransformByMatmul(data, size, inverse) {
    ...
    for(let r = 0; r < size; r++){
        ...
        for(let c = 0; c < size; c++){
            const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].exponent(r * c, size, inverse);
            const term = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].getComplexWithIndex(data, c);
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].assignToTypedArray(ret, real, imag, r);
    }
    return ret;
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-backend-cpu_dist_utils_b03fca25._.js.map