module.exports = [
"[project]/node_modules/@tensorflow/tfjs-backend-webgl/dist/shader_compiler.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$glsl_version$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-backend-webgl/dist/glsl_version.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$shader_compiler_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-backend-webgl/dist/shader_compiler_util.js [app-route] (ecmascript)");
;
const { getBroadcastDims } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"];
;
;
function makeShader(inputsInfo, outputShape, program) {
    const prefixSnippets = [];
    inputsInfo.forEach((x)=>{
        const size = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(x.shapeInfo.logicalShape);
    ...
    const glsl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$glsl_version$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlslDifferences"])();
...
function getOutput3DCoords(shape, texShape, enableShapeUniforms) {
    if (enableShapeUniforms) {
        const coordsFromIndexSnippet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$shader_compiler_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOutputLogicalCoordinatesFromFlatIndexByUniform"]([
            'r',
            'c',
            'd'
        ], shape);
...
`;
    ...
    const coordsFromIndexSnippet = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$shader_compiler_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getLogicalCoordinatesFromFlatIndex"]([
        'r',
        'c',
        'd'
    ], shape);
...
function getOutputPacked2DCoords(shape, texShape, enableShapeUniforms) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape)) {
        if (enableShapeUniforms) {
            return `
...
function getPackedSampler2D(inputInfo, enableShapeUniforms) {
    ...
    const glsl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgl$2f$dist$2f$glsl_version$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlslDifferences"])();
    if (texShape != null && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape)) {
        if (enableShapeUniforms) {
            return `
...
function getSampler2D(inputInfo, enableShapeUniforms) {
  ...
  `;
    ...
    const { newShape, keptDims } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].squeezeShape(shape);
...
function getUniformSampler(inputInfo) {
    const texName = inputInfo.name;
    const inSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(inputInfo.shapeInfo.logicalShape);
    if (inSize < 2) {
...
function getPackedSamplerAtOutputCoords(inputInfo, outShapeInfo) {
    ...
    const outSize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(outShapeInfo.logicalShape);
...
function getUniformInfoFromShape(isPacked, shape, texShape) {
    ...
    const useSqueezeShape = !isPacked && rank > 1 && !__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].arraysEqual(shape, texShape) && newShape.length < rank || useSqueezePackedShape;
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-backend-webgl_dist_shader_compiler_6511825d.js.map