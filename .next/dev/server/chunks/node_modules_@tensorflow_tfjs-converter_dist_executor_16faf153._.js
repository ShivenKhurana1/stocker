module.exports = [
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/tensor_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function assertShapesMatchAllowUndefinedSize(shapeA, shapeB, errorMessagePrefix = '') {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(shapeA.length === shapeB.length, ()=>errorMessagePrefix + ` Shapes ${shapeA} and ${shapeB} must match`);
    for(let i = 0; i < shapeA.length; i++){
        const dim0 = shapeA[i];
        const dim1 = shapeB[i];
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(dim0 < 0 || dim1 < 0 || dim0 === dim1, ()=>errorMessagePrefix + ` Shapes ${shapeA} and ${shapeB} must match`);
    }
}
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/tensor_array.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/tensor_utils.js [app-route] (ecmascript)");
;
;
class TensorArray {
    constructor(name, dtype, maxSize, elementShape, identicalElementShapes, dynamicSize, clearAfterRead){
        ...
        this.tensors = [];
        this.closed_ = false;
        this.idTensor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$scalar$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scalar"])(0);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(this.idTensor);
    }
    get id() {
     ...
     */ write(index, tensor) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.elementShape, tensor.shape, `TensorArray ${this.name}: Could not write to TensorArray index ${index}.`);
        if (t.read) {
        ...
        t.tensor = tensor;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(tensor);
        t.written = true;
     ...
     */ gather(indices, dtype) {
        ...
        if (indices.length === 0) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tensor"])([], [
                0
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.elementShape, tensors[0].shape, 'TensorArray shape mismatch: ');
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$stack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stack"])(tensors, 0);
    }
    /**
     ...
     */ concat(dtype) {
        ...
        const tensors = this.readMany(indices);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.elementShape, tensors[0].shape, `TensorArray shape mismatch: tensor array shape (${this.elementShape}) vs first tensor shape (${tensors[0].shape})`);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$concat$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["concat"])(tensors, 0);
    }
    /**
     ...
     */ scatter(indices, tensor) {
        ...
        this.writeMany(indices, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$unstack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unstack"])(tensor, 0));
    }
    /**
     ...
     */ split(length, tensor) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            tensor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(tensor, [
                1,
                totalLength,
                elementPerRow
            ]);
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/tensor_list.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TensorList {
     ...
     */ constructor(tensors, elementShape, elementDtype, maxNumElements = -1){
        ...
        if (tensors != null) {
            tensors.forEach((tensor)=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(elementShape, tensor.shape, 'TensorList shape mismatch: ');
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(tensor);
            });
        }
        this.idTensor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$scalar$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scalar"])(0);
     ...
     */ stack(elementShape, elementDtype, numElements = -1) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(elementShape, this.elementShape, 'TensorList shape mismatch: ');
        const outputElementShape = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inferElementShape"])(this.elementShape, this.tensors, elementShape);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            const reshapedTensors = this.tensors.map((tensor)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(tensor, outputElementShape));
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$stack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stack"])(reshapedTensors, 0);
        });
    }
    /**
     ...
     */ popBack(elementShape, elementDtype) {
        ...
        tensor.kept = false;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(tensor.shape, elementShape, 'TensorList shape mismatch: ');
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(tensor, outputElementShape);
    }
    /**
     ...
     */ pushBack(tensor) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(tensor.shape, this.elementShape, 'TensorList shape mismatch: ');
     ...
     */ getItem(elementIndex, elementShape, elementDtype) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.tensors[elementIndex].shape, elementShape, 'TensorList shape mismatch: ');
        const outputElementShape = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inferElementShape"])(this.elementShape, this.tensors, elementShape);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(this.tensors[elementIndex], outputElementShape);
    }
    /**
     ...
     */ setItem(elementIndex, tensor) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.elementShape, tensor.shape, 'TensorList shape mismatch: ');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(tensor);
     ...
     */ gather(indices, elementDtype, elementShape) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(this.elementShape, elementShape, 'TensorList shape mismatch: ');
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            const tensors = indices.map((i)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(this.tensors[i], outputElementShape));
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$stack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stack"])(tensors, 0);
        });
    }
    /**
     ...
     */ concat(elementDtype, elementShape) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            const tensors = this.tensors.map((t)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(t, outputElementShape));
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$concat$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["concat"])(tensors, 0);
        });
    }
}
function fromTensor(tensor, elementShape, elementDtype) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertShapesMatchAllowUndefinedSize"])(tensorElementShape, elementShape, 'TensorList shape mismatch: ');
    const tensorList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$unstack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unstack"])(tensor);
...
function scatter(tensor, indices, elementShape, numElements) {
    ...
    const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$unstack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unstack"])(tensor, 0);
...
function split(tensor, length, elementShape) {
    ...
    const outputElementShape = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$tensor_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["mergeElementShape"])(shapeWithoutFirstDim, elementShape);
    const elementPerRow = totalLength === 0 ? 0 : tensor.size / totalLength;
    const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
        const tensors = [];
        tensor = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(tensor, [
            1,
            totalLength,
        ...
        for(let i = 0; i < length.length; ++i){
            ...
            tensors[i] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$slice$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["slice"])(tensor, indices, sizes), outputElementShape);
        }
        tensor.dispose();
        return tensors;
    });
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/hash_table.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class HashTable {
     ...
     */ constructor(keyDType, valueDType){
        ...
        this.handle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$scalar$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scalar"])(0);
        // tslint:disable-next-line: no-any
        this.tensorMap = new Map();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(this.handle);
    }
    /**
     ...
     */ tensorSize() {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$scalar$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["scalar"](this.size(), 'int32');
    }
    /**
     ...
     */ async import(keys, values) {
        ...
        this.tensorMap.clear();
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            const $values = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$unstack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["unstack"])(values);
            const keysLength = $keys.length;
            const valuesLength = $values.length;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(keysLength === valuesLength, ()=>`The number of elements doesn't match, keys has ` + `${keysLength} elements, the values has ${valuesLength} ` + `elements.`);
            for(let i = 0; i < keysLength; i++){
                const key = $keys[i];
                const value = $values[i];
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(value);
     ...
     */ async find(keys, defaultValue) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$stack$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["stack"])(result);
        });
    }
    // tslint:disable-next-line: no-any
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/execution_context.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/model_analysis.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * limitations under the License.
 * =============================================================================
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/operations/executors/utils.js [app-route] (ecmascript)");
;
function getExecutionSubgraph(inputs, outputs, weightMap, initNodes) {
    ...
    const seen = new Set();
    const inputNodeNames = new Set(Object.keys(inputs).map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]));
    initNodes = initNodes || [];
    const initNodeNames = new Set(initNodes.map((node)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(node.name)[0]));
    const frontier = [
        ...outputs
    ];
...
function getNodesInTopologicalOrder(graph, executionInfo) {
    ...
    const inputNodes = Object.keys(inputs).map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]).map((name)=>graph.nodes[name]);
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/graph_executor.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/util.js [app-route] (ecmascript) <export * as util>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/operations/executors/utils.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/operations/operation_executor.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$execution_context$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/execution_context.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/model_analysis.js [app-route] (ecmascript)");
;
;
;
;
...
class GraphExecutor {
     ...
     */ compile(inputs, outputs) {
        const executionInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getExecutionSubgraph"])(inputs, outputs, this.weightMap, this._initNodes);
        ...
        const orderedNodes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNodesInTopologicalOrder"])(this.graph, executionInfo);
        const nodeLiveUntilMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNodeLiveUntilMap"])(orderedNodes);
        return {
            orderedNodes,
            nodeLiveUntilMap
        };
    ...
    cloneAndKeepTensor(tensor) {
        ...
        // tidy.
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keep"])(clone);
        return clone;
    }
     ...
     */ execute(inputs, outputs) {
        ...
        const inputNodes = names.map((name)=>this.graph.nodes[(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]]);
        const outputNodeNames = outputs.map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]);
        ...
        try {
            this.keepIntermediateTensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["env"])().getBool('KEEP_INTERMEDIATE_TENSORS');
        } catch (e) {
            this.keepIntermediateTensors = false;
        ...
        const tensorListMap = {};
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tidy"])(()=>{
            const context = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$execution_context$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ExecutionContext"](this.weightMap, tensorArrayMap, tensorListMap, this.functionExecutorMap, this.parseNodeNameCache);
            const tensorsMap = Object.assign({}, this.weightMap);
            if (this.keepIntermediateTensors) {
                this.clonedTensorsMap = this.cloneTensorMap(this.weightMap);
            }
            Object.keys(inputs).forEach((name)=>{
                const [nodeName, index] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name, context);
                const tensors = [];
            ...
            for (const node of orderedNodes){
                ...
                const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeOp"])(node, tensorsMap, context, this._resourceManager);
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].isPromise(tensors)) {
            ...
            return outputs.map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensor"])(name, tensorsMap, context));
        });
    }
    ...
    checkTensorForDisposal(nodeName, node, tensorMap, context, tensorsToKeep, outputNodeNameSet, intermediateTensorConsumerCount) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isControlFlow"])(node) || outputNodeNameSet.has(nodeName)) {
            return;
        }
        ...
        for (const input of node.inputs){
            ...
            // correctly.
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isControlFlow"])(input)) {
                continue;
            }
            const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensorsForCurrentContext"])(input.name, tensorMap, context);
            if (tensors == null) {
                continue;
            }
    ...
    checkTensorForDisposalWithNodeLiveUntilInfo(node, tensorMap, context, tensorsToKeep, outputNodeNameSet, liveUntilNodes) {
        function isNonDisposableNode(node) {
            // Skip output nodes and any control flow nodes, since its dependency is
            // tricky to track correctly.
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isControlFlow"])(node) || outputNodeNameSet.has(node.name);
        }
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isControlFlow"])(node) || liveUntilNodes == null) {
            return;
        }
        for (const nodeToDispose of liveUntilNodes){
            ...
            const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensorsForCurrentContext"])(nodeToDispose.name, tensorMap, context);
            for (const tensor of tensors){
                if (!tensor || tensor.kept || tensorsToKeep.has(tensor.id)) {
                    continue;
                }
     ...
     */ async _executeAsync(inputs, outputs, isFunctionExecution = false, tensorArrayMap = {}, tensorListMap = {}) {
        ...
        const results = outputs.map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensor"])(name, tensorsMap, context));
     ...
     */ async executeWithControlFlow(inputs, context, outputNames, isFunctionExecution) {
        ...
        const inputNodes = names.map((name)=>this.graph.nodes[(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]]);
        const outputNodeNames = outputNames.map((name)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name)[0]);
        const outputNodeNameSet = new Set(outputNodeNames);
        let outputNodes = outputNodeNames.map((name)=>this.graph.nodes[name]);
        // If no outputs are specified, then use the default outputs of the model.
        if (outputNodes.length === 0) {
        ...
        const tensorsMap = Object.assign({}, this.weightMap);
        Object.keys(inputs).forEach((name)=>{
            const [nodeName, index] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name);
            const tensors = [];
            tensors[index] = inputs[name];
            tensorsMap[nodeName] = tensors;
        });
        ...
        const missingOutputs = outputNodes.filter((node)=>!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$model_analysis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isControlFlow"])(node) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensor"])(node.name, tensorsMap, context)).map((node)=>node.name);
    ...
    processStack(inputNodes, stack, context, tensorMap, added, tensorsToKeep, outputNodeNameSet, intermediateTensorConsumerCount, usedNodes) {
        ...
        while(stack.length > 0){
            ...
            // whole loop.
            if (item.node.op === 'Enter' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getParamValue"])('isConstant', item.node, tensorMap, context)) {
                [nodeName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNodeNameAndIndex"])(item.node.name, context);
            }
            // only process nodes that are not in the tensorMap yet, this include
            // inputNodes and internal initNodes.
            if (tensorMap[item.node.name] == null) {
                const tensors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeOp"])(item.node, tensorMap, context, this._resourceManager);
                if (!nodeName) {
                    [nodeName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNodeNameAndIndex"])(item.node.name, context);
                }
    ...
    processChildNodes(node, stack, context, tensorMap, added, usedNodes) {
        node.children.forEach((childNode)=>{
            const [nodeName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getNodeNameAndIndex"])(childNode.name, context);
            ...
            if (childNode.op === 'Merge') {
                if (childNode.inputNames.some((name)=>{
                    return !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensor"])(name, tensorMap, context);
                })) {
                    added[nodeName] = true;
                    stack.push({
                        contexts: context.currentContext,
    ...
    checkInputShapeAndType(inputs) {
        Object.keys(inputs).forEach((name)=>{
            ...
            const [nodeName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name);
            ...
            if (node.attrParams['shape'] && node.attrParams['shape'].value) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(match, ()=>`The shape of dict['${node.name}'] provided in ` + `model.execute(dict) must be [${shape}], but was ` + `[${input.shape}]`);
            }
            if (node.attrParams['dtype'] && node.attrParams['dtype'].value) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(input.dtype === node.attrParams['dtype'].value, ()=>`The dtype of dict['${node.name}'] provided in ` + `model.execute(dict) must be ` + `${node.attrParams['dtype'].value}, but was ${input.dtype}`);
            }
        });
    }
    mapInputs(inputs) {
    ...
    checkOutputs(outputs) {
        outputs.forEach((name)=>{
            const [normalizedName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$executors$2f$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNodeName"])(name);
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/resource_manager.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/graph_model.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/util.js [app-route] (ecmascript) <export * as util>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_mapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/operations/operation_mapper.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$graph_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/graph_executor.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$resource_manager$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-converter/dist/executor/resource_manager.js [app-route] (ecmascript)");
...
class GraphModel {
     ...
     */ constructor(modelUrl, loadOptions = {}, tfio = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"]){
        ...
        this.resourceManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$resource_manager$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ResourceManager"]();
    }
    findIOHandler() {
     ...
     */ load() {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].isPromise(loadResult)) {
    ...
    async loadStreaming(artifacts) {
        ...
        const weightMap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["decodeWeightsStream"])(artifacts.getWeightStream(), artifacts.weightSpecs);
        return this.loadWithWeightMap(artifacts, weightMap);
    }
    loadWithWeightMap(artifacts, weightMap) {
        ...
        this.executor = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$graph_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GraphExecutor"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_mapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OperationMapper"].Instance.transformGraph(graph, this.signature));
        this.executor.weightMap = this.convertTensorMapToTensorsMap(weightMap);
        // Attach a model-level resourceManager to each executor to share resources,
        // such as `HashTable`.
        this.executor.resourceManager = this.resourceManager;
        if (artifacts.modelInitializer != null && artifacts.modelInitializer.node != null) {
            const initializer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$operations$2f$operation_mapper$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["OperationMapper"].Instance.transformGraph(artifacts.modelInitializer);
            this.initializer = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$converter$2f$dist$2f$executor$2f$graph_executor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GraphExecutor"](initializer);
    ...
    addStructuredOutputNames(outputTensors) {
        if (this.structuredOutputKeys) {
            const outputTensorsArray = outputTensors instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"] ? [
                outputTensors
            ] : outputTensors;
    ...
    normalizeInputs(inputs) {
        var _a;
        if (!(inputs instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"]) && !Array.isArray(inputs)) {
     ...
     */ dispose() {
        ...
        if (this.initializer) {
            ...
            if (this.resourceIdToCapturedInput) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dispose"])(this.resourceIdToCapturedInput);
            }
        }
        this.resourceManager.dispose();
    }
}
async function loadGraphModel(modelUrl, options = {}, tfio = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"]) {
    if (modelUrl == null) {
...
function loadGraphModelSync(modelSource) {
    ...
    if (modelSource instanceof Array) {
        ...
        const weightSpecs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"].getWeightSpecs(modelJSON.weightsManifest);
        const modelArtifacts = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"].getModelArtifactsForJSONSync(modelJSON, weightSpecs, weights);
        ioHandler = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"].fromMemorySync(modelArtifacts);
        ...
        ioHandler = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$io$2f$io$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__io$3e$__["io"].fromMemorySync(modelSource);
    } else {
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-converter_dist_executor_16faf153._.js.map