module.exports = [
"[project]/node_modules/@tensorflow/tfjs-core/dist/engine.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$profiler$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/profiler.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/tape.js [app-route] (ecmascript)");
...
class Engine {
    ...
    registerBackend(backendName, factory, priority = 1) {
        if (backendName in this.registryFactory) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$log$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["warn"](`${backendName} backend was already registered. ` + `Reusing existing backend factory.`);
            return false;
        }
    ...
    async setBackend(backendName) {
        ...
        // Reset the profiler.
        this.profiler = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$profiler$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Profiler"](this.backendInstance);
        return true;
    }
    setupRegisteredKernels() {
        const kernels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_registry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKernelsForBackend"])(this.backendName);
    ...
    disposeRegisteredKernels(backendName) {
        const kernels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_registry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKernelsForBackend"])(backendName);
        kernels.forEach((kernel)=>{
     ...
     */ initializeBackend(backendName) {
        ...
        try {
            ...
            implementations (e.g. Angular) */ if (backend && !(backend instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["KernelBackend"]) && typeof backend.then === 'function') {
                ...
                const success = backend.then((backendInstance)=>{
                    ...
                    this.pendingBackendInit = null;
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$log$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["warn"](`Initialization of backend ${backendName} failed`);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$log$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["warn"](err.stack || err.message);
                    return false;
                });
     ...
     * execution.
     */ clone(x) {
        const y = ENGINE.runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Identity"], {
            x
        });
        const inputs = {
            x
        ...
        const grad = (dy)=>({
                x: ()=>{
                    ...
                    return ENGINE.runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Cast"], gradInputs, // tslint:disable-next-line: no-unnecessary-type-assertion
                    attrs);
                }
            });
        const saved = [];
     ...
     */ runKernel(kernelName, inputs, attrs) {
        ...
        const hasKernel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_registry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKernel"])(kernelName, this.backendName) != null;
        if (!hasKernel) {
     ...
     */ runKernelFunc(kernelParams) {
        ...
        if (isRegisteredKernelInvocation(kernelParams)) {
            ...
            const kernel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_registry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getKernel"])(kernelName, this.backendName);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](kernel != null, ()=>`Cannot find registered kernel '${kernelName}' for backend '${this.backendName}'`);
            kernelFunc = ()=>{
     ...
     */ getTensorsForGradient(kernelName, inputs, outputs) {
        const gradConfig = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_registry$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGradient"])(kernelName);
        if (gradConfig != null) {
            ...
            if (gradConfig.saveAllInputs) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](Array.isArray(inputs), ()=>'saveAllInputs is true, expected inputs to be an array.');
     ...
     */ makeTensor(values, shape, dtype, backend) {
        ...
        if (dtype === 'string' && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"](values[0])) {
            backendVals = values.map((d)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["encodeString"](d));
        }
        const dataId = backend.write(backendVals, shape, dtype);
        const t = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"](shape, dtype, dataId, this.nextTensorId());
        this.trackTensor(t, backend);
        // Count bytes for string tensors.
        if (dtype === 'string') {
            const info = this.state.tensorInfo.get(dataId);
            const newBytes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bytesFromStringArray"])(backendVals);
    ...
    makeVariable(initialValue, trainable = true, name, dtype) {
        ...
        const v = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Variable"](initialValue, trainable, name, this.nextTensorId());
    ...
    trackTensor(a, backend) {
        ...
        if (a.dtype !== 'complex64' && a.dtype !== 'string') {
            bytes = a.size * __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bytesPerElement"](a.dtype);
        }
        ...
        if (!(a instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Variable"])) {
            this.track(a);
        }
    }
    ...
    disposeTensor(a) {
        ...
        // components.
        if (a.dtype !== 'complex64' && a.dtype !== 'string') {
            const bytes = a.size * __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bytesPerElement"](a.dtype);
            this.state.numBytes -= bytes;
        }
            ...
            tapeNode.gradient = (dys)=>{
                ...
                dys = dys.map((dy, i)=>{
                    if (dy == null) {
                        ...
                        const vals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeZerosTypedArray"](output.size, output.dtype);
     ...
     * as scope() without the need for a function closure.
     */ endScope(result) {
        const tensorsToTrackInParent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getTensorsInContainer"])(result);
     ...
     */ gradients(f, xs, dy, allowNoGradients = false) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](xs.length > 0, ()=>'gradients() received an empty list of xs.');
        if (dy != null && dy.dtype !== 'float32') {
            throw new Error(`dy must have 'float32' dtype, but has '${dy.dtype}'`);
        }
        const y = this.scopedRun(()=>this.startTape(), ()=>this.endTape(), ()=>this.tidy('forward', f));
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](y instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"], ()=>'The result y returned by f() must be a tensor.');
        // Filter out the nodes that don't connect x => y.
        const filteredTape = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFilteredNodesXToY"])(this.state.activeTape, xs, y);
        ...
        return this.tidy('backward', ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["backpropagateGradients"])(accumulatedGradientMap, filteredTape, // Pass the tidy function to avoid circular dep with `tape.ts`.
    ...
    customGrad(f) {
        ...
        return (...inputs)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](inputs.every((t)=>t instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"]), ()=>'The args passed in customGrad(f)(x1, x2,...) must all be ' + 'tensors');
            let res;
            const inputMap = {};
            ...
            const forwardFunc = (_, save)=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](res.value instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"], ()=>'The function f passed in customGrad(f) must return an ' + 'object where `obj.value` is a tensor');
            ...
            const backwardsFunc = (dy, saved)=>{
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](grads.length === inputs.length, ()=>'The function f passed in customGrad(f) must return an ' + 'object where `obj.gradFunc` is a function that returns ' + 'the same number of tensors as inputs passed to f(...).');
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](grads.every((t)=>t instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Tensor"]), ()=>'The function f passed in customGrad(f) must return an ' + 'object where `obj.gradFunc` is a function that returns ' + 'a list of only tensors.');
                const gradMap = {};
    ...
    async time(query) {
        const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["now"])();
        const timingInfo = await this.backend.time(query);
        timingInfo.wallMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["now"])() - start;
        return timingInfo;
    }
    /**
...
;
function ones(shape) {
    const values = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeOnesTypedArray"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sizeFromShape"])(shape), 'float32');
    return ENGINE.makeTensor(values, shape, 'float32');
}
function getOrMakeEngine() {
    const ns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$global_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGlobalNamespace"])();
    if (ns._tfengine == null) {
        const environment = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Environment"](ns);
        ns._tfengine = new Engine(environment);
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setEnvironmentGlobal"])(ns._tfengine.ENV);
    // Tell the current tensor interface that the global engine is responsible
    // for tracking.
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setTensorTracker"])(()=>ns._tfengine);
    return ns._tfengine;
}
...
function add(a, b) {
    ...
    return ENGINE.runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Add"], inputs);
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-core_dist_engine_0deba182.js.map