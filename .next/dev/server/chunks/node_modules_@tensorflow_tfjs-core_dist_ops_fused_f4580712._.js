module.exports = [
"[project]/node_modules/@tensorflow/tfjs-core/dist/ops/fused/conv2d.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function fusedConv2d_({ x, filter, strides, pad, dataFormat = 'NHWC', dilations = [
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldFuse"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].state.gradientDepth, activation) === false) {
        // TODO: Transpose bias and preluActivationWeights properly for NCHW
        // format before computation.
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](dataFormat === 'NHWC', ()=>`Error in fused conv2d: got dataFormat of ${dataFormat} but ` + `only NHWC is currently supported for the case of gradient depth ` + `is 0 and the activation is not linear.`);
        let result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv2d$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conv2d"])(x, filter, strides, pad, dataFormat, dilations, dimRoundingMode);
        if (bias != null) {
            result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$add$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add"])(result, bias);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyActivation"])(result, activation, preluActivationWeights, leakyreluAlpha);
    }
    const $x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(x, 'x', 'conv2d', 'float32');
    const $filter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(filter, 'filter', 'conv2d', 'float32');
    let x4D = $x;
    let reshapedTo4D = false;
    if ($x.rank === 3) {
        reshapedTo4D = true;
        x4D = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])($x, [
            1,
            $x.shape[0],
            $x.shape[1],
            $x.shape[2]
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](x4D.rank === 4, ()=>`Error in fused conv2d: input must be rank 4, but got rank ` + `${x4D.rank}.`);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"]($filter.rank === 4, ()=>`Error in fused conv2d: filter must be rank 4, but got rank ` + `${$filter.rank}.`);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkPadOnDimRoundingMode"]('fused conv2d', pad, dimRoundingMode);
    const inputChannels = dataFormat === 'NHWC' ? x4D.shape[3] : x4D.shape[1];
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"]($filter.shape[2] === inputChannels, ()=>`Error in conv2d: depth of input (${inputChannels}) must match ` + `input depth for filter ${$filter.shape[2]}.`);
    ...
    const convInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeConv2DInfo"](x4D.shape, $filter.shape, strides, dilations, pad, dimRoundingMode);
    let $bias;
    if (bias != null) {
        $bias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(bias, 'bias', 'fused conv2d');
        [$bias] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeTypesMatch"])($bias, $x);
        ...
        if (dataFormat === 'NHWC') {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$broadcast_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertAndGetBroadcastShape"](convInfo.outShape, $bias.shape);
        } else {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"]($bias.shape.length <= 1, ()=>`Error in fused conv2d: only supports scalar or 1-D Tensor ` + `bias for NCHW format but got the bias of ` + `rank-${$bias.shape.length}.`);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"]($bias.shape.length === 0 || $bias.shape[0] === convInfo.outChannels || $bias.shape[0] === 1, ()=>`Error in fused conv2d: bias shape (${$bias.shape}) is not ` + `compatible with the number of output channels ` + `(${convInfo.outChannels})`);
        }
    }
    ...
    if (preluActivationWeights != null) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](alphaShape.length <= 1 || alphaShape.length === 3, ()=>`Error in fused conv2d: only supports scalar, 1-D Tensor or ` + `3-D Tensor PReLU activation weights but got a tensor of ` + `rank-${alphaShape.length}.`);
        if (alphaShape.length === 1) {
            ...
            // result.
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](alphaShape[0] === 1 || alphaShape[0] === convInfo.outChannels, ()=>`Error in fused conv2d: PReLU activation weights ` + `(${alphaShape}) is not compatible with the number of output ` + `channels (${convInfo.outChannels}).`);
            ...
            try {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$broadcast_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertAndGetBroadcastShape"](alphaShape, convInfo.outShape);
            } catch (e) {
        ...
        $preluActivationWeights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(preluActivationWeights, 'prelu weights', 'fused conv2d');
    }
    const grad = (dy, saved)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](dataFormat === 'NHWC', ()=>`Error in gradient of fused conv2D: got dataFormat of ${dataFormat} but only NHWC is currently supported.`);
        const [$filter, x4D, y, $bias] = saved;
        const dyActivation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedDyActivation"])(dy, y, activation);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tupleValuesAreOne"](dilations), ()=>'Error in gradient of fused conv2D: ' + `dilation rates greater than 1 ` + `are not yet supported in gradients. Got dilations '${dilations}'`);
        const xDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv2d_backprop_input$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conv2DBackpropInput"])(x4D.shape, dyActivation, $filter, strides, pad);
        const filterDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv2d_backprop_filter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["conv2DBackpropFilter"])(x4D, dyActivation, $filter.shape, strides, pad);
        const der = [
            xDer,
            filterDer
        ];
        if ($bias != null) {
            const biasDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedBiasGradient"])($bias, dyActivation);
            der.push(biasDer);
        }
        return der;
    };
    ...
    if (bias == null) {
        const customOp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$gradients$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customGrad"])((x4D, filter, save)=>{
            let res = // tslint:disable-next-line: no-unnecessary-type-assertion
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FusedConv2D"], inputs, attrs);
            save([
                filter,
                x4D,
                res
            ...
            if (reshapedTo4D) {
                ...
                res = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(res, [
                    res.shape[1],
                    res.shape[2],
                    res.shape[3]
                ]);
        ...
        const customOpWithBias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$gradients$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customGrad"])((x4D, filter, bias, save)=>{
...
const conv2d = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$operation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["op"])({
    fusedConv2d_
...
"[project]/node_modules/@tensorflow/tfjs-core/dist/ops/fused/depthwise_conv2d.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function fusedDepthwiseConv2d_({ x, filter, strides, pad, dataFormat = 'NHWC', dilations = [
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldFuse"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].state.gradientDepth, activation) === false) {
        let result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$depthwise_conv2d$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["depthwiseConv2d"])(x, filter, strides, pad, dataFormat, dilations, dimRoundingMode);
        if (bias != null) {
            result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$add$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add"])(result, bias);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyActivation"])(result, activation, preluActivationWeights, leakyreluAlpha);
    }
    const $x = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(x, 'x', 'depthwiseConv2d', 'float32');
    const $filter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(filter, 'filter', 'depthwiseConv2d', 'float32');
    let x4D = $x;
    let reshapedTo4D = false;
    if ($x.rank === 3) {
        reshapedTo4D = true;
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](x4D.rank === 4, ()=>`Error in fused depthwiseConv2d: input must be rank 4, but got ` + `rank ${x4D.rank}.`);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"]($filter.rank === 4, ()=>`Error in fused depthwiseConv2d: filter must be rank 4, ` + `but got rank ${$filter.rank}.`);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](x4D.shape[3] === $filter.shape[2], ()=>`Error in fused depthwiseConv2d: number of input channels ` + `(${x4D.shape[3]}) must match the inChannels dimension in ` + `filter ${$filter.shape[2]}.`);
    if (dilations == null) {
        dilations = [
            1,
            1
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkPadOnDimRoundingMode"]('fused depthwiseConv2d', pad, dimRoundingMode);
    const convInfo = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeConv2DInfo"](x4D.shape, $filter.shape, strides, dilations, pad, dimRoundingMode, true);
    let $bias;
    if (bias != null) {
        $bias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(bias, 'bias', 'fused conv2d');
        [$bias] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeTypesMatch"])($bias, $x);
    ...
    let $preluActivationWeights;
    if (preluActivationWeights != null) {
        $preluActivationWeights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(preluActivationWeights, 'prelu weights', 'fused depthwiseConv2d');
    }
    const grad = (dy, saved)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$conv_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tupleValuesAreOne"](dilations), ()=>'Error in gradient of fused depthwiseConv2d: dilation rates ' + `greater than 1 are not yet supported. Got dilations ` + `'${dilations}'`);
        const [$filter, x4D, y, bias] = saved;
        const dyActivation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedDyActivation"])(dy, y, activation);
        const xDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$depthwise_conv2d_native_backprop_input$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["depthwiseConv2dNativeBackpropInput"])(x4D.shape, dyActivation, $filter, strides, pad, dilations, dimRoundingMode);
        const filterDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$depthwise_conv2d_native_backprop_filter$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["depthwiseConv2dNativeBackpropFilter"])(x4D, dyActivation, $filter.shape, strides, pad, dilations, dimRoundingMode);
        if (bias != null) {
            const biasDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedBiasGradient"])($bias, dyActivation);
            return [
                xDer,
    ...
    if (bias == null) {
        const customOp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$gradients$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customGrad"])((x4D, filter, save)=>{
            // tslint:disable-next-line: no-unnecessary-type-assertion
            let res = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["FusedDepthwiseConv2D"], inputs, attrs);
            save([
                filter,
                x4D,
                res
...
const depthwiseConv2d = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$operation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["op"])({
...
"[project]/node_modules/@tensorflow/tfjs-core/dist/ops/fused/mat_mul.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function fusedMatMul_({ a, b, transposeA = false, transposeB = false, bias, activation = 'linear', preluActivationWeights, leakyreluAlpha = 0.2 }) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["shouldFuse"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].state.gradientDepth, activation) === false) {
        let result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(a, b, transposeA, transposeB);
        if (bias != null) {
            result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$add$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["add"])(result, bias);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["applyActivation"])(result, activation, preluActivationWeights, leakyreluAlpha);
    }
    let $a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(a, 'a', 'fused matMul');
    let $b = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(b, 'b', 'fused matMul');
    [$a, $b] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeTypesMatch"])($a, $b);
    ...
    const batchDimA = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sizeFromShape"](outerDimsA);
    const batchDimB = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sizeFromShape"](outerDimsB);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util_base$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assert"](innerShapeA === innerShapeB, ()=>`Error in fused matMul: inner shapes (${innerShapeA}) and (` + `${innerShapeB}) of Tensors with shapes ${$a.shape} and ` + `${$b.shape} and transposeA=${transposeA}` + ` and transposeB=${transposeB} must match.`);
    const outShapeOuterDims = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$broadcast_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertAndGetBroadcastShape"]($a.shape.slice(0, -2), $b.shape.slice(0, -2));
    const outShape = outShapeOuterDims.concat([
        outerShapeA,
        outerShapeB
    ]);
    const a3D = transposeA ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])($a, [
        batchDimA,
        innerShapeA,
        outerShapeA
    ]) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])($a, [
        batchDimA,
        outerShapeA,
        innerShapeA
    ]);
    const b3D = transposeB ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])($b, [
        batchDimB,
        outerShapeB,
        innerShapeB
    ]) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])($b, [
        batchDimB,
        innerShapeB,
        outerShapeB
    ]);
    let $bias;
    if (bias != null) {
        $bias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(bias, 'bias', 'fused matMul');
        [$bias] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeTypesMatch"])($bias, $a);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$broadcast_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertAndGetBroadcastShape"](outShape, $bias.shape);
    }
    let $preluActivationWeights;
    if (preluActivationWeights != null) {
        $preluActivationWeights = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$tensor_util_env$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["convertToTensor"])(preluActivationWeights, 'prelu weights', 'fused matMul');
    }
    const grad = (dy, saved)=>{
        ...
        // the customOp.
        const dyActivation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedDyActivation"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(dy, y.shape), y, activation);
        let aDer;
        let bDer;
        if (!transposeA && !transposeB) {
            aDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(dyActivation, b3D, false, true);
            bDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(a3D, dyActivation, true, false);
        } else if (!transposeA && transposeB) {
            aDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(dyActivation, b3D, false, false);
            bDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(dyActivation, a3D, true, false);
        } else if (transposeA && !transposeB) {
            aDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(b3D, dyActivation, false, true);
            bDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(a3D, dyActivation, false, false);
        } else {
            aDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(b3D, dyActivation, true, true);
            bDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$mat_mul$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["matMul"])(dyActivation, a3D, true, true);
        }
        if (bias != null) {
            const biasDer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$fused_util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFusedBiasGradient"])($bias, dyActivation);
            return [
    ...
    // inputs and thus a a different number of elements in the gradient.
    if (bias == null) {
        const customOp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$gradients$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customGrad"])((a3D, b3D, save)=>{
            const res = // tslint:disable-next-line: no-unnecessary-type-assertion
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_FusedMatMul"], inputs, attrs);
            save([
                a3D,
                b3D,
                res
            ...
            return {
                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$reshape$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reshape"])(res, outShape),
                gradFunc: grad
            };
        });
        return customOp(a3D, b3D);
    } else {
        const customOpWithBias = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$gradients$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["customGrad"])((a3D, b3D, $bias, save)=>{
            const res = // tslint:disable-next-line: no-unnecessary-type-assertion
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$engine$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ENGINE"].runKernel(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$kernel_names$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["_FusedMatMul"], inputs, attrs);
            save([
                a3D,
...
const matMul = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$ops$2f$operation$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["op"])({
    fusedMatMul_
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-core_dist_ops_fused_f4580712._.js.map