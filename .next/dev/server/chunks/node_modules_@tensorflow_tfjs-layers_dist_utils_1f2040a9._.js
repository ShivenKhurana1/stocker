module.exports = [
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/executor_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/generic_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * https://opensource.org/licenses/MIT.
 * =============================================================================
 */ /* Original source: utils/generic_utils.py */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@tensorflow/tfjs-core/dist/index.js [app-route] (ecmascript) <locals>");
...
function assert(val, message) {
    if (!val) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AssertionError"](message);
    }
}
...
function objectListUid(objs) {
    ...
    for (const obj of objectList){
        if (obj.id == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Object ${obj} passed to objectListUid without an id`);
        }
        if (retVal !== '') {
            retVal = retVal + ', ';
        }
...
function deserializeKerasObject(identifier, moduleObjects = {}, customObjects = {}, printableModuleName = 'object', fastWeightInit = false) {
    ...
    if (typeof identifier === 'string') {
        ...
        if (functionName in customObjects) {
            ...
            if (fn == null) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Unknown ${printableModuleName}: ${identifier}. ` + `This may be due to one of the following reasons:\n` + `1. The ${printableModuleName} is defined in Python, in which ` + `case it needs to be ported to TensorFlow.js or your JavaScript ` + `code.\n` + `2. The custom ${printableModuleName} is defined in JavaScript, ` + `but is not registered properly with ` + `tf.serialization.registerClass().`);
        ...
        if (config['className'] == null || config['config'] == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`${printableModuleName}: Improper config format: ` + `${JSON.stringify(config)}.\n` + `'className' and 'config' must set.`);
        }
        ...
        if (cls == null) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Unknown ${printableModuleName}: ${className}. ` + `This may be due to one of the following reasons:\n` + `1. The ${printableModuleName} is defined in Python, in which ` + `case it needs to be ported to TensorFlow.js or your JavaScript ` + `code.\n` + `2. The custom ${printableModuleName} is defined in JavaScript, ` + `but is not registered properly with ` + `tf.serialization.registerClass().`);
        // TODO(cais): Add link to tutorial page on custom layers.
        }
        if (fromConfig != null) {
...
function stringToDType(dtype) {
    switch(dtype){
        case 'float32':
            return 'float32';
        default:
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Invalid dtype: ${dtype}`);
    }
}
...
function isObjectEmpty(obj) {
    if (obj == null) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Invalid value in obj: ${JSON.stringify(obj)}`);
    }
...
function checkStringTypeUnionValue(values, label, value) {
    ...
    if (values.indexOf(value) < 0) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`${value} is not a valid ${label}.  Valid values are ${values} or null/undefined.`);
    }
}
...
function assertPositiveInteger(value, name) {
    if (Array.isArray(value)) {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(value.length > 0, ()=>`${name} is unexpectedly an empty array.`);
        value.forEach((v, i)=>assertPositiveInteger(v, `element ${i + 1} of ${name}`));
    } else {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(Number.isInteger(value) && value > 0, ()=>`Expected ${name} to be a positive integer, but got ` + `${formatAsFriendlyString(value)}.`);
    }
}
...
function debounce(f, waitMs, nowFunc) {
    let lastTime = nowFunc != null ? nowFunc() : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].now();
    let lastResult;
    const f2 = (...args)=>{
        const now = nowFunc != null ? nowFunc() : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].now();
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/math_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function range(begin, end) {
    if (end < begin) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`end (${end}) < begin (${begin}) is forbidden.`);
    }
    const out = [];
    for(let i = begin; i < end; ++i){
        out.push(i);
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/types_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function getExactlyOneTensor(xs) {
    ...
    if (Array.isArray(xs)) {
        if (xs.length !== 1) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Expected Tensor length to be 1; got ${xs.length}`);
        }
        x = xs[0];
    } else {
        x = xs;
...
function getExactlyOneShape(shapes) {
    if (Array.isArray(shapes) && Array.isArray(shapes[0])) {
        if (shapes.length === 1) {
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Expected exactly 1 Shape; got ${shapes.length}`);
        }
    } else {
        return shapes;
    }
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/variable_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/layer_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
printFn = console.log) {
    ...
    const nonTrainableCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$variable_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countParamsInWeights"])(model.nonTrainableWeights);
...
function countTrainableParams(model) {
    ...
    if (model.collectedTrainableWeights != null) {
        trainableCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$variable_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countParamsInWeights"])(model.collectedTrainableWeights);
    } else {
        trainableCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$variable_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["countParamsInWeights"])(model.trainableWeights);
    }
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/serialization_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function convertPythonicToTs(pythonicConfig, key) {
    if (pythonicConfig === null) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$generic_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toCamelCase"](pythonicConfig);
        ...
        for (const pythonicKey of Object.keys(pythonicConfig)){
            ...
            if (pythonicKey === 'name' && typeof pythonicValue === 'string') {
                ...
                const tsKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$generic_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toCamelCase"](pythonicKey);
...
function convertTsToPythonic(tsConfig, key) {
    if (tsConfig === null || tsConfig === undefined) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$generic_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toSnakeCase"](tsConfig);
        ...
        for (const tsKey of Object.keys(tsConfig)){
            ...
            const pyKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$generic_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["toSnakeCase"](tsKey);
...
"[project]/node_modules/@tensorflow/tfjs-layers/dist/utils/conv_utils.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function normalizeArray(value, n, name) {
    if (typeof value === 'number') {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$generic_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pyListRepeat"])(value, n);
    } else {
        if (value.length !== n) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`The ${name} argument must be an integer or tuple of ${n} integers.` + ` Received: ${value.length} elements.`);
        }
        for(let i = 0; i < n; ++i){
            const singleValue = value[i];
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$math_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isInteger"])(singleValue)) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`The ${name} argument must be an integer or tuple of ${n}` + ` integers. Received: ${JSON.stringify(value)} including a` + ` non-integer number ${singleValue}`);
            }
        }
        return value;
    }
...
function deconvLength(dimSize, strideSize, kernelSize, padding) {
    ...
    if (padding === 'valid') {
        dimSize = dimSize * strideSize + (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$utils$2f$math_utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["max"])([
        ...
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$layers$2f$dist$2f$errors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ValueError"](`Unsupport padding mode: ${padding}.`);
    }
    return dimSize;
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-layers_dist_utils_1f2040a9._.js.map