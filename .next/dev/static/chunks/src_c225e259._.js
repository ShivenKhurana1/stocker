...
"[project]/src/components/WalkthroughGuide.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WalkthroughGuide(t0) {
    ...
    if ($[0] !== "4c38a63f887b9ef900af184fb3778231ae66aa6bbd66253d85169e1d0804181a") {
        for(let $i = 0; $i < 85; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4c38a63f887b9ef900af184fb3778231ae66aa6bbd66253d85169e1d0804181a";
    }
    const { hasPrediction } = t0;
    ...
    const [autoAdvanced, setAutoAdvanced] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t1;
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "WalkthroughGuide[useEffect()]": ()=>{
                setMounted(true);
                const hasSeenTour = localStorage.getItem("stocker_tour_completed");
                if (!hasSeenTour) {
                    const timer = setTimeout({
                        "WalkthroughGuide[useEffect() > setTimeout()]": ()=>setIsVisible(true)
                    }["WalkthroughGuide[useEffect() > setTimeout()]"], 800);
    ...
    let t3;
    let t4;
    if ($[3] !== autoAdvanced || $[4] !== currentStep || $[5] !== hasPrediction) {
        t3 = ({
            "WalkthroughGuide[useEffect()]": ()=>{
                if (hasPrediction && currentStep === 2 && !autoAdvanced) {
                    setAutoAdvanced(true);
                    setTimeout({
                        "WalkthroughGuide[useEffect() > setTimeout()]": ()=>{
                            setCurrentStep(3);
                        }
                    }["WalkthroughGuide[useEffect() > setTimeout()]"], 500);
                }
            }
        })["WalkthroughGuide[useEffect()]"];
        t4 = [
    ...
    let t5;
    if ($[8] !== currentStep || $[9] !== isVisible) {
        t5 = ({
            "WalkthroughGuide[updateTargetRect]": ()=>{
                if (!isVisible) {
                    return;
                }
    ...
    const updateTargetRect = t5;
    let t6;
    let t7;
    if ($[11] !== updateTargetRect) {
        t6 = ({
            "WalkthroughGuide[useEffect()]": ()=>{
                updateTargetRect();
    ...
    let handleNext;
    let handleSkip;
    if ($[14] !== currentStep || $[15] !== hasPrediction) {
        handleNext = ({
            "WalkthroughGuide[handleNext]": ()=>{
                const step_0 = steps[currentStep];
                if (step_0.requiresAction && !hasPrediction) {
                    return;
                }
        ...
        handleSkip = ({
            "WalkthroughGuide[handleSkip]": ()=>{
                completeTour();
            }
        })["WalkthroughGuide[handleSkip]"];
        const completeTour = {
            "WalkthroughGuide[completeTour]": ()=>{
    ...
    if (!mounted || !isVisible || !targetRect) {
        return null;
    }
    const step_1 = steps[currentStep];
    const isBlocked = step_1.requiresAction && !hasPrediction;
    const t8 = targetRect.top - 8;
    const t9 = targetRect.left - 8;
    const t10 = targetRect.width + 16;
    const t11 = targetRect.height + 16;
    const t12 = isBlocked ? "0 0 0 9999px rgba(0, 0, 0, 0.85), 0 0 30px rgba(239, 68, 68, 0.5)" : "0 0 0 9999px rgba(0, 0, 0, 0.75), 0 0 20px rgba(56, 219, 197, 0.3)";
    let t13;
    if ($[18] !== t10 || $[19] !== t11 || $[20] !== t12 || $[21] !== t8 || $[22] !== t9) {
        t13 = {
            position: "fixed",
            top: t8,
            left: t9,
    ...
    const spotlightStyle = t13;
    let t14;
    if ($[24] !== step_1.position || $[25] !== targetRect.bottom || $[26] !== targetRect.height || $[27] !== targetRect.left || $[28] !== targetRect.right || $[29] !== targetRect.top || $[30] !== targetRect.width) {
        const getTooltipStyle = {
            "WalkthroughGuide[getTooltipStyle]": ()=>{
                let top = targetRect.top;
                let left = targetRect.left;
                bb64: switch(step_1.position){
                    case "bottom":
                        {
                ...
                left = Math.max(16, Math.min(left, window.innerWidth - 280 - 16));
                top = Math.max(16, Math.min(top, window.innerHeight - 140 - 16));
                return {
                    position: "fixed",
                    top,
                    left,
        ...
        t14 = getTooltipStyle();
        $[24] = step_1.position;
        $[25] = targetRect.bottom;
        $[26] = targetRect.height;
        $[27] = targetRect.left;
        $[28] = targetRect.right;
        $[29] = targetRect.top;
        $[30] = targetRect.width;
    ...
    const tooltipStyle = t14;
    let t15;
    if ($[32] !== spotlightStyle) {
    ...
    const t16 = `rounded-2xl border p-4 shadow-2xl backdrop-blur-xl ${isBlocked ? "border-rose-500/40 bg-slate-950/95" : "border-cyan-500/30 bg-slate-950/95"}`;
    const t17 = `flex h-5 w-5 items-center justify-center rounded-full text-xs font-bold ${isBlocked ? "bg-rose-500/20 text-rose-400" : "bg-cyan-500/20 text-cyan-400"}`;
    const t18 = currentStep + 1;
    let t19;
    if ($[34] !== t17 || $[35] !== t18) {
    ...
    const t20 = `text-xs font-medium ${isBlocked ? "text-rose-400" : "text-cyan-400"}`;
    const t21 = currentStep + 1;
    let t22;
    if ($[37] !== t20 || $[38] !== t21) {
    ...
    let t23;
    if ($[40] !== isBlocked) {
        t23 = isBlocked && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    if ($[48] !== step_1.description) {
        ...
        $[48] = step_1.description;
        $[49] = t26;
    } else {
        t26 = $[49];
    }
    let t27;
    if ($[50] !== isBlocked || $[51] !== step_1.actionMessage) {
        t27 = isBlocked && step_1.actionMessage && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t29;
    if ($[55] !== currentStep) {
        t29 = currentStep > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            onClick: {
                "WalkthroughGuide[<button>.onClick]": ()=>setCurrentStep(currentStep - 1)
            }["WalkthroughGuide[<button>.onClick]"],
    ...
    const t30 = `rounded-lg px-3 py-1.5 text-[11px] font-semibold transition-colors ${isBlocked ? "bg-slate-700/50 text-slate-400 cursor-not-allowed" : "bg-cyan-500/20 text-cyan-300 hover:bg-cyan-500/30"}`;
    const t31 = currentStep === steps.length - 1 ? "Finish" : isBlocked ? "Run Prediction" : "Next";
    let t32;
    if ($[57] !== handleNext || $[58] !== isBlocked || $[59] !== t30 || $[60] !== t31) {
    ...
    let t35;
    if ($[68] !== currentStep || $[69] !== isBlocked) {
        t35 = steps.map({
            "WalkthroughGuide[steps.map()]": (_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t37;
    if ($[73] !== t16 || $[74] !== t24 || $[75] !== t25 || $[76] !== t26 || $[77] !== t27 || $[78] !== t34 || $[79] !== t36 || $[80] !== tooltipStyle) {
    ...
    if ($[82] !== t15 || $[83] !== t37) {
        ...
        t38 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(content, document.body);
        $[82] = t15;
        $[83] = t37;
        $[84] = t38;
    } else {
...
_s(WalkthroughGuide, "/Pb0UwPFjUVoeYsjuTn5n8b7IAo=");
_c = WalkthroughGuide;
;
var _c;
__turbopack_context__.k.register(_c, "WalkthroughGuide");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$WalkthroughGuide$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/WalkthroughGuide.tsx [app-client] (ecmascript)");
;
...
function PriceChart(t0) {
    ...
    if ($[0] !== "813963c827f4b7bb73cf3c42cad0e89dec76796a04dc2342635248ba602c6071") {
        for(let $i = 0; $i < 214; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "813963c827f4b7bb73cf3c42cad0e89dec76796a04dc2342635248ba602c6071";
    }
...
function Portfolio(t0) {
    ...
    const { items, onRemove, onSelect, onQuickAdd, "data-tour": dataTour } = t0;
    ...
    let t5;
    let t6;
    if ($[1] !== dataTour || $[2] !== items || $[3] !== onQuickAdd || $[4] !== quickTicker) {
        ...
        let t7;
        if ($[11] !== onQuickAdd || $[12] !== quickTicker) {
            t7 = ({
        ...
        let t8;
        if ($[14] !== items) {
            t8 = items.filter(_PortfolioItemsFilter);
            $[14] = items;
            $[15] = t8;
        } else {
            t8 = $[15];
        }
        const highRiskAssets = t8;
        let t9;
        if ($[16] !== items) {
            t9 = items.reduce(_PortfolioItemsReduce3, items[0]);
            $[16] = items;
            $[17] = t9;
        } else {
            t9 = $[17];
        }
        const topOpportunity = t9;
        t1 = dataTour;
        t2 = "glass-panel animate-fade-up rounded-3xl p-4 md:p-8 overflow-hidden";
        let t10;
        ...
        if ($[28] !== handleQuickAdd || $[29] !== t12 || $[30] !== t15) {
        ...
        const t17 = formatCurrency(totalValue);
        let t18;
        if ($[33] !== t17) {
        ...
        const t20 = `mt-1 text-2xl font-semibold ${totalGain >= 0 ? "text-emerald-300" : "text-rose-300"}`;
        let t21;
        if ($[36] !== gainPercent) {
            t21 = formatPercent(gainPercent);
            $[36] = gainPercent;
            $[37] = t21;
        } else {
            t21 = $[37];
    ...
    let t7;
    if ($[44] !== items || $[45] !== onRemove || $[46] !== onSelect) {
        t7 = items.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t9;
    if ($[50] !== t1 || $[51] !== t2 || $[52] !== t3 || $[53] !== t4 || $[54] !== t5 || $[55] !== t6 || $[56] !== t8) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$WalkthroughGuide$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                "data-tour": "sentiment",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(NewsSentiment, {
...
//# sourceMappingURL=src_c225e259._.js.map